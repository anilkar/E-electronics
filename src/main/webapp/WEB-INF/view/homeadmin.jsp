...
<!-- header -->
	<div class="agileits_header">
		...
		<div class="w3l_header_right1">
			<h2><a href="<c:url value="contact"/>">Contact Us</a></h2>
		</div>
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="<c:url value="/"/>"><span>Grocery</span> Store</a></h1>
			</div>
...
<!-- banner -->
	<div class="banner">
		...
		<button type="button" class="btn btn-success btn-lg">Add Category</button>
			<button type="button" class="btn btn-success btn-lg">Add Supplier</button>
		
			</section>
			<!-- flexSlider -->
				<link rel="stylesheet" href="<c:url value="resources/css/flexslider.css"/>" type="text/css" media="screen" property="" />
			...
			<div class="agile_top_brands_grids">
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="tag"><img src="<c:url value="resources/images/tag.png" />"alt=" " class="img-responsive" /></div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<c:url value="resources/images/1.png"/>" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="<c:url value="resources/images/3.png"/>" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											 <a href="single.html"><img src="<c:url value="resources/images/2.png"/>"/></a>
				...
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid_pos">
								<img src="<c:url value="/resources/images/offer.png"/>" />
							</div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<c:url value="resources/images/4.png"/>"></a>
											<p>dogs food (4 Kg)</p>
