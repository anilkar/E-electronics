		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="aboutus">About Us</a><i>/</i></li>
		...
		<div class="privacy about">
			...
			<div class="agile_about_grids">
				<div class="col-md-6 agile_about_grid_right">
					<img src="resources/images/31.jpg"/>"
				</div>
		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="<c:url value="resources/images/32.jpg" /> " class="img-responsive" />
					<h4>Martin Paul</h4>
					<p>Manager</p>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="<c:url value="resources/images/34.jpg"/> "  />
					<h4>Thomas Carl</h4>
					<p>Supervisor</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-md-3 agileits_team_grid">
					<img src="<c:url value="resources/images/35.jpg"/>"/>
					<h4>Laura Lee</h4>
					<p>CEO</p>
					<ul class="agileits_social_icons agileits_social_icons_team">
						<li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
