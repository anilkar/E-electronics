...
<!-- //font-awesome icons -->
<!-- js -->
<script src="resourcesjs/jquery-1.11.1.min.js"></script>
<!-- //js -->
...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="<c:url value="/"/>">Home</a><span>|</span></li>
				<li>Services</li>
			</ul>
		</div>
	</div>
			...
			<div class="w3ls_service_grids">
				...
				<div class="col-md-7 w3ls_service_grid_right">
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="<c:url value="resources/images/18.jpg" /> " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="<c:url value="resources/images/19.jpg" /> " class="img-responsive" />
					</div>
					<div class="col-md-4 w3ls_service_grid_right_1">
						<img src="<c:url value="resources/images/20.jpg" /> " class="img-responsive" />
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
			...
			<div class="agile_footer_grids">
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						...
						<img src="<c:url value="resources/images/card.png" /> " class="img-responsive" />
					</div>
				</div>
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
